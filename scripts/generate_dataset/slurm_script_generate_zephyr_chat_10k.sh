#!/bin/bash
#SBATCH --job-name=generate_fake_true_dataset_zephyr
...
python src/generate_fake_true_dataset.py --generator=zephyr --batch_size=16 --experiment_name=zephyr_10k --fake_dataset_size=10000 --prompt="Continue to write this news article:"
conda deactivate
